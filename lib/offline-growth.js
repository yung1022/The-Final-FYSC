/**
 * Shared offline-growth math.
 *
 * Formula (unchanged from the client): the longer a player has been offline,
 * the closer their pending growth gets to the full `growth` value:
 *
